...
var Purchases = AbstractAction.extend({
    events: {
        ...
        "click #supplier": function(e) {
            e.preventDefault();
            this.do_action('inventory_log.binhex_supplier_kanban_action',{
                    additional_context: {
                    },
        ...
        "click #destPlace": function(e) {
            ...
            if (this.location) {
                this.do_action('material_move.binhex_location_kanban_action',{
                    additional_context: {
                        type: "dest",
                        n_action: "inventory_log.binhex_purchases",
                    },
                    clear_breadcrumbs: true
                });
            }
        ...
        "click .exit": function(e) {
            ...
            this.do_action('inventory_log.binhex_main_screen',{
                    additional_context: {},
                    clear_breadcrumbs: true
                });
        },
        ...
        "click .start": function(e) {
            ...
            this._rpc({
                ...
                if (res.length) {
                    ...
                    self.do_action('inventory_log.binhex_end_screen_p');
                    return;
                }
                $(".modal").modal('show')
            });
    ...
    start: async function () {
        ...
        this.getSession().user_has_group('material_move.group_use_locations').then(function(has_group) {
    ...
    _onBarcodeScanned: function(barcode) {
        ...
        this._rpc({
                ...
                if (modif)
                    self.do_action("inventory_log.binhex_purchases",{clear_breadcrumbs: true});
                else{
